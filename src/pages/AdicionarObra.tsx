    ...
    <IonPage>
      ...
      <IonContent className="ion-padding">
        <IonInput
          ...
          onIonChange={(e: any) => setNomeObra(e.target.value)}
        ></IonInput>

        <IonInput
          required
          placeholder="Responsável:"
          onIonChange={(e: any) => setResponsavel(e.target.value)}
        ></IonInput>

        <IonInput
          required
          placeholder="Local:"
          onIonChange={(e: any) => setLocal(e.target.value)}
        ></IonInput>
        ...
        <IonInput
          ...
          onIonChange={(e: any) => setDiaInicio(e.target.value)}
        ></IonInput>
        <IonInput
          required
          type="number"
          placeholder="Mês de Inicio:    "
          onIonChange={(e: any) => setMesInicio(e.target.value)}
        ></IonInput>
        <IonInput
          required
          type="number"
          placeholder="Ano de Inicio:    "
          onIonChange={(e: any) => setAnoInicio(e.target.value)}
        ></IonInput>
        ...
        <IonInput
          ...
          onIonChange={(e: any) => setDiaEntrega(e.target.value)}
        ></IonInput>
        <IonInput
          required
          type="number"
          placeholder="Mês de Entrega:  "
          onIonChange={(e: any) => setMesEntrega(e.target.value)}
        ></IonInput>
        <IonInput
          required
          type="number"
          placeholder="Ano de Entrega:  "
          onIonChange={(e: any) => setAnoEntrega(e.target.value)}
        ></IonInput>

        <IonInput
          required
          type="number"
          placeholder="Valor Pago pela Obra:"
          onIonChange={(e: any) => setValorPago(e.target.value)}
        ></IonInput>
